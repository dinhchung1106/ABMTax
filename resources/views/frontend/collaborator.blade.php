                        ...
                        <div class="wg-sidebar">
                            ...
                            <div class="wg-date wg-sidebar-content">
                                ...
                                <fieldset class="flex items-center">
                                    ...
                                    <input class="text-body-3" type="text" name="date-in" id="datepicker2" tabindex="2"
                            ...
                            <div class="form-people wg-sidebar-content">
                                ...
                                <div class="number-people style-default dropdown-toggle" id="Boxsearch1"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="Boxsearch1">
                                    <li class="text-body-3 dropdown-item">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input type="text" name="number-adults1" value="0" id="number-adults1"
                                                class="number-adults">
                                    ...
                                    <li class="text-body-3 dropdown-item">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input type="text" name="number-children1" value="0" id="number-children1"
                                    ...
                                    <li class="text-body-3 dropdown-item">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input type="text" name="number-infants1" value="0" id="number-infants1"
                                    ...
                                    <li class="text-body-3 dropdown-item">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input type="text" name="number-pets1" value="0" id="number-pets1"
                                                class="number-pets">
                            ...
                            <div class="range-slider wg-sidebar-content">
                                ...
                                <div id="range-two-val-1" class="range-two-val"></div>

                                <div class="bottom">
                                    <div class="value">
                                        <div class="price-min" id="skip-value-lower-1"></div>
                                        <span>-</span>
                                        <div class="price-max" id="skip-value-upper-1"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 pb-30">
                                <div class="tour-layout-list hover-img wow fadeInUp">
                                    <div class="image">
                                        ...
                                        <div class="heart tf-action-btns"></div>
                                        <span class="number caption-1">
                                            1/8
                                        </span>
                                        <a class="caption-2 tf-btn style-uppercase">Adventure</a>
                                    </div>
                                    <div class="tour-layout-list-content w-full">
                                        <div class="top">
                                            <a class="country text-body-3">
                                                <svg width="18" height="24" viewBox="0 0 24 28" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        ...
                                                        stroke="#64666C" stroke-width="1.2" stroke-linecap="round"
                                            ...
                                            <div class="rating fw-6 text-body-3">
                                                4.2
                                                <i class="icon-star1"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tour-layout-list-detalis">
                            ...
                            <div class="col-12 pb-30">
                                <div class="tour-layout-list hover-img wow fadeInUp">
                                    ...
                                    <div class="tour-layout-list-content">
                                        <div class="top">
                                            <a class="country text-body-3">
                                                <svg width="18" height="24" viewBox="0 0 24 28" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-12 pb-30">
                                <div class="tour-layout-list hover-img wow fadeInUp">
                                    <div class="image">
                                        ...
                                        <a class="caption-2 tf-btn style-uppercase">Beach</a>
                                    </div>
                                    <div class="tour-layout-list-content w-full">
                                        <div class="top">
                                            <a class="country text-body-3">
