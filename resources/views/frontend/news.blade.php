...
@section('title', 'Tin tức - ' . ($company->name ?? 'ABM Tax'))
@section('meta_description', 'Tin tức, bài viết mới nhất về thuế, kế toán, hóa đơn điện tử tại ' . ($company->name ?? 'ABM Tax'))
@section('content')
...
<div class="page-title">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-content">
                            <p class="text-body-3 text wow fadeInUp"><a href="#"> Home</a> &nbsp; / &nbsp;Blog Post</p>
        ...
        <div class="main-content tf-spacing-1">
            <div class="tf-container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="list-blog hover-img tf-spacing-2">
                            <div class="image  wow fadeInUp">
                                ...
                                <a href="#" class="date">
                                    ...
                                    <span class="text-body-3">FEB</span>
                                </a>
                            </div>
                            <div class="list-blog-content">
                                <div class="tags wow fadeInUp">
                                    <div class="date-post tags-content">
                                        <div class="frame">
                                            <div class="icon">
                                    ...
                                    <div class="comment tags-content">
                                        <div class="frame">
                                            <div class="icon">
                                ...
                                <h4 class="title wow fadeInUp">
                                    <a href="{{ route('frontend.news.show', 1) }}">Top 10 Must-Visit Travel Destinations for Adventure Seekers
                                        Who Crave
                                        Excitement and
                                        Thrills</a>
                                </h4>
                                <div class="text text-body-2 wow fadeInUp">June is Pride Month, a time to celebrate and
                                    support the
                                    LGBTQ+ community. In this article, we explore how brands can develop authentic Pride
                                    Month marketing strategies that resonate with audiences...
                                </div>
                            </div>
                        </div>
                        <div class="list-blog hover-img tf-spacing-2">
                            <div class="image  wow fadeInUp">
                                <img src="image/blog/blog-defaults-2.jpg" data-src="image/blog/blog-defaults-2.jpg"
                                    alt="" class="lazyload">
                                <a href="#" class="date">
                                    <span class="day">
                                        28
                            ...
                            <div class="list-blog-content">
                                ...
                                <h4 class="title wow fadeInUp">
                                    <a href="{{ route('frontend.news.show', 1) }}">Camping Essentials: What You Need for an Unforgettable
                                        Outdoor Experience in Any Season</a>
                                </h4>
                                <div class="text text-body-2 wow fadeInUp">June is Pride Month, a time to celebrate and
                                    support the
                                    LGBTQ+ community. In this article, we explore how brands can develop authentic Pride
                        ...
                        <div class="list-blog hover-img">
                            <div class="image  wow fadeInUp">
                                <img src="image/blog/blog-defaults-3.jpg" data-src="image/blog/blog-defaults-3.jpg"
                                    alt="" class="lazyload">
                                <a href="#" class="date">
                                    <span class="day">
                                        28
                            ...
                            <div class="list-blog-content">
                                ...
                                <h4 class="title wow fadeInUp">
                                    <a href="{{ route('frontend.news.show', 1) }}">Tour Highlights: Discover the Best Sights and Experiences
                                        in Iconic Destinations Around the Globe</a>
                                </h4>
                                <div class="text text-body-2 wow fadeInUp">June is Pride Month, a time to celebrate and
                                    support the
                                    LGBTQ+ community. In this article, we explore how brands can develop authentic Pride
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar">
                            ...
                            <div class="wg-relatest-post sidebar-content">
                                <h6 class="title">Relatest Post</h6>
                                <div class="blog-grid hover-img">
                                    <div class="image ">
                                ...
                                <div class="relatest-list hover-img">
                                    <div class="image ">
                                ...
                                <div class="relatest-list hover-img">
                                    ...
                                    <div class="relatest-list-content">
                                        ...
                                        <h6 class="title">
                                            <a href="#">
                                                Explore the World Without Breaking
                                            </a>
                                        </h6>
                                    </div>
                                </div>
                                <div class="relatest-list hover-img">
                                    ...
                                    <div class="relatest-list-content">
                                        ...
                                        <h6 class="title">
                                            <a href="#">
                                                What's Hot in the World of Tours and Adventures
                                            </a>
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="wg-categories sidebar-content">
                                <h6 class="title">Categories</h6>
                                <ul class="sidebar-categories-list">
                                    <li class="item"><a href="#" class="text-body-3">Camping</a></li>
                                    <li class="item"><a href="#" class="text-body-3">Tours</a></li>
                                    <li class="item"><a href="#" class="text-body-3">Travel</a></li>
                                    <li class="item"><a href="#" class="text-body-3">Mountant</a></li>
                                    <li class="item"><a href="#" class="text-body-3">Sea</a></li>
                                </ul>
                            </div>
                            <div class="wg-popular-tag sidebar-content">
                                <h6 class="title">Popular Tag</h6>
                                <div class="tag-list">
                                    <a href="#" class="tag">Adventure Travel</a>
                                    ...
                                    <a href="#" class="tag">Travel Tips and Advice</a>
                                    <a href="#" class="tag">Tour Packages</a>
                                </div>
                            </div>
                        </div>
                    </div>
